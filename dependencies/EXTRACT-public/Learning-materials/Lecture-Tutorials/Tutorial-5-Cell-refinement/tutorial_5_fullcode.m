...
% 
% M = [jones_file ':/data'];
M = h5read('/Users/xiaochuncai/Desktop/postdoc lab/ComputationalAnalysis/EXTRACT-public/Learning-materials/Sample data/m_12_07_01_24_60um_ch1_MC.h5','/mov',[1,1,1],[512,512,18001]);
% config = get_defaults([]);
...
config.thresholds.spatial_corrupt_thresh = 4;
...
plot_stacked_traces_double(T_ex(1:59,:),[],0)

save('/Users/xiaochuncai/Desktop/postdoc lab/ComputationalAnalysis/EXTRACT-public/Learning-materials/Sample data/m_12_07_01_24_60um_ch1_MC_extractout.mat', 'output');
