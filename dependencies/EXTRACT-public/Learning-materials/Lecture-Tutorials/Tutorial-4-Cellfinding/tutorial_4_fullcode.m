...
M = h5read('/Users/xiaochuncai/Desktop/postdoc lab/ComputationalAnalysis/EXTRACT-public/Learning-materials/Sample data/m_12_07_01_24_60um_ch1_MC.h5','/mov',[1,1,1],[512,512,5000]);
config = get_defaults([]);
M_proc = preprocess_movie(M,config);
view_movie(M_proc(:,:,1:1000))
