...
clc
setupEXTRACT;
if ~isfile('m_12_07_01_24_60um_ch1_MC.h5')
    ...
    rng(1)
    create_1p_movie(opts_2p,opts_back,'m_12_07_01_24_60um_ch1_MC');
end

info = h5info('m_12_07_01_24_60um_ch1_MC.h5');
info.Datasets.Name
info.Datasets.Dataspace

%% h5read function and watching the preprocessed movie

M = h5read('m_12_07_01_24_60um_ch1_MC.h5','/mov', ...
    [1,1,1],[100,100,1000]);
...
M_small = h5read('m_12_07_01_24_60um_ch1_MC.h5','/mov', ...
    [1,1,1],[50,50,1000]);
...
preprocess_save('m_12_07_01_24_60um_ch1_MC.h5:/mov',config)

%% Run EXTRACT

M = h5read('m_12_07_01_24_60um_ch1_MC_final.h5','/mov');
config = get_defaults([]);
config.preprocess = 0;
config.use_gpu = 0;
...
config.F_per_pixel = h5read('m_12_07_01_24_60um_ch1_MC_final.h5','/F_per_pixel');
output = extractor(M,config);

a = load('m_12_07_01_24_60um_ch1_MC.mat');
